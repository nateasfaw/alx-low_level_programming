...
*of wildcmp() to sum
*add the return value of bandersnatch() to sum 	 *convert non-zero to 1, keeps 0 at 0, return
*/
if (*s2 == '*')
{
s2 = move(s2);
...
/**
*bandersnatch - checks recursively 
*for all the paths when the
...
*if chars are equal,
*return the return value of wildcmp()
